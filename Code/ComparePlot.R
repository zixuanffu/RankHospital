...
dir.create("Figures/2013-2022/GMM_fd", showWarnings = TRUE)
dir.create("Figures/2013-2022/GMM_fd/GLmix", showWarnings = TRUE)
pdf(paste0("Figures/2013-2022/GMM_fd/GLmix/Left_", alpha, "_", gamma, ".pdf"), height = 4.5 * 3, width = 8)
# png(paste0("Figures/2013-2022/GMM_fd/GLmix/Left_", alpha, "_", gamma, ".png"), height = 450 * 3, width = 800)
par(mfrow = c(3, 2))
for (i in c(4, 5, 6)) {
...
for (rule_index in c(4, 5, 6)) {
    filepath <- paste0("Figures/2013-2022/GMM_fd/GLmix/Contour_Left_", alpha, "_", gamma, "_", Rules[2], "_", Rules[rule_index], ".pdf")
    print(filepath)
...
pdf(paste0("Figures/2013-2022/GMM_fd/GLmix/Right_", alpha, "_", gamma, ".pdf"), height = 4.5 * 3, width = 8)
# png(paste0("Figures/2013-2022/GMM_fd/GLmix/Right_", alpha, "_", gamma, ".png"), height = 450 * 3, width = 800)
par(mfrow = c(3, 2))
for (i in c(4, 5, 6)) {
...
for (rule_index in c(2, 4, 5)) {
    filepath <- paste0("Figures/2013-2022/GMM_fd/GLmix/Contour_Right_", alpha, "_", gamma, "_", Rules[2], "_", Rules[rule_index], ".pdf")
    print(filepath)
    pdf(filepath, height = 4.5, width = 8)
    par(mfrow = c(1, 2))
...
for (rule_index in c(2, 4, 5, 6)) {
    filepath <- paste0("Figures/2013-2022/GMM_fd/GLmix/Left_", alpha, "_", gamma, "_", Rules[rule_index], ".pdf")
    print(filepath)
