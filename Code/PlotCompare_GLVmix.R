...
sL <- select2d(Z, alpha = alpha, gamma = 0.05, tail = "L")
sR <- select2d(Z, alpha = alpha, gamma = 0.05, tail = "R")
apply(sL$A, 2, sum)
apply(sL$B, 2, sum)
...
png("Figures/2013-2022/UnknownVariance/Right_0.20_0.05.png", height = 450 * 3, width = 800)
par(mfrow = c(3, 2))
for (i in c(4, 5, 6)) {
...
pdf("Figures/2013-2022/Spec3/UnknownVariance/Left_0.20_0.05.pdf", height = 450 * 3, width = 800)
par(mfrow = c(3, 2))
for (i in c(4, 5, 6)) {
