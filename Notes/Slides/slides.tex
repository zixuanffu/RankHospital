...
\begin{frame}
  ...
  \begin{enumerate}\itemsep=12pt
    \item \textbf{Estimate the efficiency} with input demand function.
          ...
          \end{equation*}
    \item \textbf{Estimate the prior distribution of $\theta_i$} with NPMLE.
...
\begin{frame}[fragile]
  ...
  \begin{equation*}
    \hat{G}=\argmin_{G\in \mathcal{G}} \set{-\sum_{i=1}^{n}\log g(y_i)\bigg | g(y_i)=\int  \p(y_i |\theta)dG(\theta) }
  \end{equation*}
